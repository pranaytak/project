...
function searchText(text) {
    ...
    const elements = document.querySelectorAll(".service h2"); // Target specific elements for highlighting
    let textFound = false;
...
//for creds
        ...
        let checkCred = ()=>{
            if (!sessionStorage.getItem("user-creds"))
                ...
                greetHead.innerText = `Welcome To UrbanCare ${userInfo.firstName + " " + userInfo.lastName}!`;
            }
